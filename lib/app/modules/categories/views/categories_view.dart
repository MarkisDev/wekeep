                ...
                child: Column(
                    ...
                    children: [
                      GFAvatar(
                        ...
                        backgroundImage: NetworkImage(authenticationController
                          ...
                          onPressed: () {
                            Get.defaultDialog(
                                content: Obx(() => ColorPicker(
                                      pickerColor: categoriesController
                                          .pickedColor.value,
                                      onColorChanged:
                          ...
                          child: (categoriesController.categoryChanged == false)
                              ...
                              : Row(
                                  ...
                                  children: [
                                    Text('Choose color'),
                                    GFAvatar(
                                      backgroundColor: categoriesController
                                          .pickedColor.value,
                                      size: 14,
                                    ),
                                  ],
                ...
                ElevatedButton(
                    onPressed: () async {
                      if (categoriesController.nameController.text.isEmpty) {
                        ...
                        categoriesController.nameController.clear();
                        categoriesController.categoryChanged.value = false;
                      }
                    },
